///
/// \class l1t::Phase2TrackTriggerFirmware
///
/// \author: Tom James
///
...
//#include "L1Trigger/L1TrackTrigger/interface/CaloTools.h"
#include "CondFormats/L1TObjects/interface/TrackTriggerParams.h"


l1t::Phase2TrackTriggerFirmware::Phase2TrackTriggerFirmware(TrackTriggerParams* 
params) :
  params_(params)
{
